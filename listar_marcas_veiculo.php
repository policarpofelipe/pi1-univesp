                ...
                <div class="p-5 md:p-6">
                    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        <div>
                            ...
                            <h1 class="mt-2 text-2xl md:text-3xl font-bold">Marcas de Veículo</h1>
                            <p class="mt-2 text-sm text-slate-300">Gerencie as marcas que compõem o catálogo veicular do sistema.</p>
                        </div>
            ...
            <div class="<?= classe_box() ?> mb-6">
                <form method="GET" class="grid grid-cols-1 gap-4 md:grid-cols-12 md:items-end">
                    ...
                    <div class="md:col-span-3 flex gap-2">
                        ...
                        <?= botao_link('listar_marcas_veiculo.php', 'Limpar', 'cancelar', ['style' => 'width:100%; text-align:center;']) ?>
                    </div>
                </form>
            </div>
            ...
            <div class="<?= classe_box() ?>">
                ...
                <?php if (!$marcas): ?>
                    <div class="rounded-xl border border-dashed border-slate-300 bg-slate-50 px-6 py-10 text-center">
                        ...
                        <div class="mt-4">
                            <?= botao_link('form_marca_veiculo.php', 'Cadastrar primeira marca', 'salvar') ?>
                        </div>
                    </div>
                <?php else: ?>
                                    ...
                                    <tr class="overflow-hidden rounded-xl bg-slate-50 shadow-sm">
                                        ...
                                        <td class="rounded-r-xl px-4 py-4">
                                            <div class="flex items-center justify-end gap-2">
                                                <?= botao_link(
                                                    'form_marca_veiculo.php?id=' . (int)$marca['id'],
                                                    'Editar',
                                                    'editar'
                                                ) ?>
