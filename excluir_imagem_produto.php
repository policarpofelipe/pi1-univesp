...
if (!excluirImagemProduto($pdo, $produtoId, $imagemId)) {
    header('Location: form_produto.php?id=' . $produtoId . '&erro=imagem_exclusao_falhou');
    exit;
}

header('Location: form_produto.php?id=' . $produtoId . '&sucesso=imagem_excluida');
exit;
