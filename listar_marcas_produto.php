    ...
    $mapa = [
        'sucesso' => [
            'cadastrado' => [
                ...
                'texto'  => 'Marca de produto cadastrada com sucesso.',
            ],
            'editado' => [
                'classe' => 'border-emerald-200 bg-emerald-50 text-emerald-700',
                'texto'  => 'Marca de produto atualizada com sucesso.',
            ],
            'excluido' => [
                'classe' => 'border-emerald-200 bg-emerald-50 text-emerald-700',
                'texto'  => 'Marca de produto excluÃ­da com sucesso.',
            ],
            'inativado' => [
        ...
        'erro' => [
            ...
            'erro_ao_excluir' => [
                'classe' => 'border-red-200 bg-red-50 text-red-700',
                'texto'  => 'Ocorreu um erro ao excluir a marca de produto.',
            ],
        ],
    ];
        ...
        <div class="mx-auto max-w-7xl">
                ...
                <div class="p-5 md:p-6">
                    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        <div>
                            ...
                            <h1 class="mt-2 text-2xl md:text-3xl font-bold">Marcas de Produto</h1>
                            <p class="mt-2 text-sm text-slate-300">Gerencie as marcas comerciais associadas aos produtos do catalogo.</p>
                        </div>
            ...
            <div class="<?= classe_box() ?> mb-6">
                <form method="GET" class="grid grid-cols-1 gap-4 md:grid-cols-12 md:items-end">
                    ...
                    <div class="md:col-span-3 flex gap-2">
                        ...
                        <?= botao_link('listar_marcas_produto.php', 'Limpar', 'cancelar', ['style' => 'width:100%; text-align:center;']) ?>
                    </div>
                </form>
            </div>
            ...
            <div class="mb-4 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
                <div class="<?= classe_box() ?>">
                    ...
                    <div class="mt-2 text-3xl font-bold text-slate-900"><?= $totalMarcas ?></div>
                </div>
            ...
            <div class="<?= classe_box() ?>">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="text-lg font-semibold text-slate-900">Lista de marcas de produto</h2>
                </div>
                ...
                <?php if (!$marcas): ?>
                    <div class="rounded-xl border border-dashed border-slate-300 bg-slate-50 px-6 py-10 text-center">
                        ...
                        <div class="mt-4">
                            <?= botao_link('form_marca_produto.php', 'Cadastrar primeira marca', 'salvar') ?>
                        </div>
                    </div>
                <?php else: ?>
                                    ...
                                    <tr class="overflow-hidden rounded-xl bg-slate-50 shadow-sm">
                                        ...
                                        <td class="rounded-r-xl px-4 py-4">
                                            <div class="flex items-center justify-end gap-2">
                                                <?= botao_link(
                                                    'form_marca_produto.php?id=' . (int)$marca['id'],
                                                    'Editar',
                                                    'editar'
                                                ) ?>

                                                <?= botao_excluir(
                                                    'excluir_marca_produto.php?id=' . (int)$marca['id'],
                                                    'Tem certeza que deseja excluir esta marca de produto?',
                                                    'Excluir'
                                                ) ?>
                                            </div>
                                        </td>
